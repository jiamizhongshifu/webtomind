-- Respect explicit dynamic image-generation prices above the legacy max_cost cap.
-- Multi-image and premium image tasks pass allowDynamicCostAboveMax=true with
-- dynamicCredits already calculated by the application pricing module.
