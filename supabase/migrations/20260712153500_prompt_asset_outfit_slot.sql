-- Preserve complete coordinated looks in a dedicated slot instead of mixing
-- them into the single-garment top and bottom axes.
...
ALTER TABLE public.prompt_assets
  ...
  CHECK (
    slot IN (
      'character', 'expression', 'pose', 'top', 'bottom', 'outfit', 'shoes',
